...
@Service("CoMaintainerService")
public class CoMaintainerServiceImpl implements CoMaintainerService {
    /**
     ...
     */
    @Override
    public ResponseEntity<Object> queryPackages(PackageSearchCondition condition) {
