...
import com.easysoftware.application.collaboration.CoAdminServiceImpl;
...
public class CoAdminAdapterTest {
    @Autowired
    private WebApplicationContext webApplicationContext;

    @InjectMocks
    private CoAdminServiceImpl coAdminService;
    ...
    void testQueryRepos() throws Exception {
        performAdminQueryRepos();
    }
    
    private void performAdminQueryRepos() throws Exception {
        when(userPermission.checkUserPermission(UerPermissionDef.COLLABORATION_PERMISSION_ADMIN.split(","))).thenReturn(true);
        ...
        ResultVo res = CommonUtil.executeGet(mockMvc, "/collaboration/admin/user/repos", paramMap);
